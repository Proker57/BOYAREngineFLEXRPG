...
public class FreeStatsColumnMainFrame implements StatsFrame {
    ...
    private String HPC, APC, WPNC, NAMEC, VDKC, BEERC, CTLC, DEFC, LVLC, EVDC, CRTC, STRC, DEXC, CONC;
    ...
    public FreeStatsColumnMainFrame(int index, int xpos) {
        ...
        slNAMEC = new StaticLayout(NAMEC, FontManager.FreeStatsCoumnMainFrameStats(), (int)(rect.width() - (Constants.CURRENT_CONTEXT.getResources().getDimensionPixelSize(R.dimen.freeStatsColumnMainFrame_stats_text) * 1.2f)), Layout.Alignment.ALIGN_CENTER, 1.0f, 0, false);
